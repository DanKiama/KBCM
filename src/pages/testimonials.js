       ...
       <div className="inner">
        <div className="row">
          <div className="col-md-12 align-center py-4">
              ...
              <h4>( Our Customers Love )</h4>
          </div>
          <div className="col-md-4 col-sm-12 col-12 testimonial-area">
            <div className="card-item">
              <div className="card d-flex flex-column">
                <div className="main font-weight-bold pb-2 pt-1">When a refugee seeks refuge and finds Faraja (comfort)</div>
          ...
          <div className="col-md-4 col-sm-12 col-12 testimonial-area">
            <div className="card-item">
              <div className="card d-flex flex-column">
                <div className="main font-weight-bold pb-2 pt-1">An overzealous doctor led to an early diagnosis</div>
                <div className="testimonial"> 
          ...
          <div className="col-md-4 col-sm-12 col-12 testimonial-area">
            <div className="card-item">
              <div className="card d-flex flex-column">
                <div className="main font-weight-bold pb-2 pt-1">Confronting doctors led to a right diagnosis</div>
                <div className="testimonial"> 
